...
sat in Back Extra, leaving its meaning card unanswerable before he could read the script, and the 2026-09-03 card
that played an Egyptian (maSri) pronunciation he is never tested on. The suite fails if the checker passes any BAD case
