...
- `reference/editor-checklist.md` — the 27-point "try to break this card" adversarial pass.
...
- `reference/regression-cases.md` — R1–R28, every flaw ever caught, with the BAD card it must
