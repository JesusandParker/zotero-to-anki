...
for glyph, name, sound, video, fam in LETTERS:
    ...
    add(text, back, "A_letters", [1,12,15] + ([13] if glyph in "اوي" else []),
        image="src_alphabet_chart_v3.png",
...
for shown, name, sound in SYMBOLS:
    ...
    add(text, back, "B_symbols", [2] + ([13,15] if name in ("fatHa","Damma","kasra") else []),
        image="src_symbols_chart_v3.png",
...
add("The fourteen extra-alphabetical symbols fall into these kinds: {{c1::short vowels}}, "
    ...
    "B_symbols", [2], image="src_symbols_chart_v3.png",
...
add("The four major characteristics that set Arabic script apart from European ones: "
    ...
    "D_system", [3,4,5,6], image="src_alphabet_chart_v3.png",
...
add("In this book's transliteration, emphatic sounds are marked by {{c1::UPPERCASE letters (S vs s)}}, "
    ...
    "<br><br><img src=\"arabic_src_consonants2_v3.png\">",
    "D_system", [12], image="src_consonants1_v3.png",
...
add("Formal Arabic has only {{c1::three::how many}} vowel qualities — {{c1::a, i, u}} — each short or long; "
    ...
    "D_system", [13], numeric=True, image="src_vowels_v3.png",
...
CGROUND = dict(image="src_arab_map_v3.png",
